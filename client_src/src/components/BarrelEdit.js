 ...
 this.handleInputChange = this.handleInputChange.bind(this);
    ...
    return (
            ...
            <form onSubmit = {this.onSubmit.bind(this)}>
                ...
                <div className = "input-field" >
                    <input type="date" class="datepicker" name = "date_planted" ref = "date_planted" value = {this.state.date_planted} onChange = {this.handleInputChange} />
                    <label htmlFor = "date_planted" ></label>
                </div>
                <div className = "input-field" >
                    <input type="text" className="datepicker" name = "date_last_checked" ref = "date_last_checked"  value = {this.state.date_last_checked} onChange = {this.handleInputChange} />
